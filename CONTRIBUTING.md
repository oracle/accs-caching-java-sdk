Contributing to the ACCS Application Cache Java API 
===================================================

_Copyright (c) 2017 Oracle and/or its affiliates The Universal Permissive License (UPL), Version 1.0_

<h4>Becoming a Contributor</h4>

Contributing to the ACCS Application Cache Java API Project can be done in various ways,
...
**Note 1:** For the "Project Name:" please write "ACCS Application Cache Java API Project".
